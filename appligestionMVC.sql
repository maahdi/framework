...
--
-- Serveur: localhost
-- Généré le : Mar 28 Mai 2013 à 17:01
...
INSERT INTO `articles` (`idArticle`, `refArticle`, `designation`, `prixHT`, `txTVA`, `stock`, `idFournisseur`) VALUES
(4000, 'FXR79DNR7WV', 'salut a toi l\\\\\\\\\\\\\\''amiee', 65.52, 12, 8, 3002),
(4001, 'UEW31OBE1KG', 'Hello world !!', 4520.58, 19.6, 10, 3009),
(4002, 'YCT68RTJ3MG', 'eleifend nec, malesuada ut, sem.', 200.515, 19.6, 5, 3009),
(4003, 'YVB82EKH3OR', 'cursus, diam at pretium aliquet,', 2815.56, 19.6, 5, 3005),
(4004, 'HZO05KRI7BV', 'erat semper rutrum. Fusce dolor', 800.959, 19.6, 4, 3000),
(4005, 'CNX13EIT4RI', 'vulputate ullamcorper magna. Sed eu', 2000, 19.6, 7, 3001),
(4006, 'UAC30RTS0OT', 'ac turpis egestas. Aliquam fringilla', 3614, 19.6, 9, 3004),
(4007, 'RCY62ITP0EG', 'aliquet libero. Integer in magna.', 1856, 19.6, 6, 3001),
(4008, 'KIE56FFM9FA', 'velit in aliquet lobortis, nisi', 499, 19.6, 6, 3007),
(4009, 'MHU49BUR6WV', 'eget mollis lectus pede et', 1874, 19.6, 3, 3004),
(4010, 'LOU60MWG9UM', 'mi. Aliquam gravida mauris ut', 2944, 19.6, 6, 3006),
(4011, 'EBX94UAH4QE', 'Nunc mauris. Morbi non sapien', 3172, 19.6, 5, 3004),
(4012, 'ZYZ75BGK3FF', 'eget, venenatis a, magna. Lorem', 1083, 19.6, 7, 3003),
(4013, 'TWJ68WLV1WM', 'condimentum eget, volutpat ornare, facilisis', 988, 19.6, 7, 3008),
(4014, 'OYS57HPZ7XE', 'vulputate, nisi sem semper erat,', 4061, 19.6, 4, 3006),
(4015, 'ZCL37HFE1JA', 'hendrerit. Donec porttitor tellus non', 4091, 19.6, 2, 3006),
(4016, 'MTN12GMW2ET', 'volutpat. Nulla dignissim. Maecenas ornare', 548, 19.6, 4, 3007),
(4017, 'RLU17NJA6MJ', 'ac orci. Ut semper pretium', 449, 19.6, 4, 3009),
(4018, 'QNQ16XJD7PI', 'non, dapibus rutrum, justo. Praesent', 5819, 19.6, 4, 3010),
(4019, 'RBK41FAO1SA', 'magna. Duis dignissim tempor arcu.', 2489, 19.6, 3, 3006),
(4020, 'HSC98UVG9PV', 'quam vel sapien imperdiet ornare.', 1003, 19.6, 7, 3007),
(4021, 'DMS59XTZ4YR', 'amet orci. Ut sagittis lobortis', 3020, 19.6, 3, 3006),
(4022, 'CJH22DAC3ZS', 'sit amet lorem semper auctor.', 1472, 19.6, 9, 3010),
(4023, 'XZM65KNG3ZE', 'orci. Phasellus dapibus quam quis', 2724, 19.6, 7, 3001),
(4024, 'AUM30TLA8VZ', 'hendrerit. Donec porttitor tellus non', 187, 19.6, 3, 3004),
(4025, 'ACL47YXG2HF', 'faucibus lectus, a sollicitudin orci', 2085, 19.6, 7, 3001),
(4026, 'MRW99XSL9PG', 'lectus pede et risus. Quisque', 1026, 19.6, 3, 3001),
(4027, 'PHF07ZZQ2EX', 'porttitor interdum. Sed auctor odio', 3634, 19.6, 3, 3001),
(4028, 'RSV56VLK2JZ', 'mus. Proin vel nisl. Quisque', 1590, 19.6, 2, 3008),
(4029, 'JSC57VOS4TX', 'Vivamus molestie dapibus ligula. Aliquam', 1390, 19.6, 6, 3006),
(4030, 'JFI17AZF4GP', 'Vivamus molestie dapibus ligula. Aliquam', 4654, 19.6, 9, 3005),
(4031, 'OFF67ZMI6YC', 'suscipit, est ac facilisis facilisis,', 1990, 19.6, 4, 3001),
(4032, 'YQH28CHU3RB', 'libero. Morbi accumsan laoreet ipsum.', 497, 19.6, 9, 3008),
(4033, 'OKY80SUN0MM', 'Donec feugiat metus sit amet', 495, 19.6, 8, 3004),
(4034, 'ETB40XOI6WA', 'Suspendisse ac metus vitae velit', 4601, 19.6, 2, 3006),
(4035, 'NQY44AEG5FS', 'id, erat. Etiam vestibulum massa', 2072, 19.6, 8, 3009),
(4036, 'TYO84PSZ9KW', 'Curabitur massa. Vestibulum accumsan neque', 1047, 19.6, 7, 3010),
(4037, 'SDQ65CST3GY', 'Ut tincidunt vehicula risus. Nulla', 1623, 19.6, 3, 3008),
(4038, 'CBT68EFP1DA', 'consectetuer adipiscing elit. Curabitur sed', 338, 19.6, 2, 3006),
(4039, 'AXT65HTH0CN', 'aliquet nec, imperdiet nec, leo.', 826, 19.6, 8, 3002),
(4040, 'XWH64EVS7ZW', 'dictum eu, placerat eget, venenatis', 5918, 19.6, 9, 3010),
(4041, 'PXW35LQJ7RL', 'egestas rhoncus. Proin nisl sem,', 3873, 19.6, 6, 3000),
(4042, 'XMW11JJZ0DZ', 'ac mattis velit justo nec', 5435, 19.6, 9, 3008),
(4043, 'WOT78IDN6WE', 'egestas a, dui. Cras pellentesque.', 1200, 19.6, 9, 3007),
(4044, 'DSE09IJG2LK', 'lobortis. Class aptent taciti sociosqu', 2340, 19.6, 3, 3002),
(4045, 'FET98QGA1XX', 'lacus. Aliquam rutrum lorem ac', 251, 19.6, 1, 3001),
(4046, 'SDX81UEM0LY', 'tellus eu augue porttitor interdum.', 4326, 19.6, 4, 3008),
(4047, 'YNX64UJS7NQ', 'vel lectus. Cum sociis natoque', 5236, 19.6, 7, 3007),
(4048, 'BJU92YSJ4UV', 'ligula. Nullam feugiat placerat velit.', 1459, 19.6, 6, 3007),
(4049, 'ZMG81RQN3LA', 'malesuada id, erat. Etiam vestibulum', 40, 19.6, 10, 3007),
(4050, 'UYA58FOP5ZJ', 'leo. Cras vehicula aliquet libero.', 2211, 19.6, 6, 3010),
(4051, 'BOL34PZC1JO', 'Integer vitae nibh. Donec est', 2482, 19.6, 7, 3000),
(4052, 'BLZ00WIP4XO', 'Quisque imperdiet, erat nonummy ultricies', 1955, 19.6, 10, 3004),
(4053, 'HZZ62LHH5KR', 'amet risus. Donec egestas. Aliquam', 3204, 19.6, 1, 3008),
(4054, 'ODF52HKO8VL', 'nulla. Cras eu tellus eu', 3934, 19.6, 8, 3004),
(4055, 'BAJ07RMA9AK', 'Donec consectetuer mauris id sapien.', 721, 19.6, 10, 3007),
(4056, 'WMW00CJL6GH', 'nibh. Quisque nonummy ipsum non', 4244, 19.6, 10, 3009),
(4057, 'CZX40QDM6CM', 'quam, elementum at, egestas a,', 4426, 19.6, 6, 3010),
(4058, 'LMM25NKY9AE', 'lobortis. Class aptent taciti sociosqu', 820, 19.6, 9, 3002),
(4059, 'ZZF84FMO7DR', 'turpis. Aliquam adipiscing lobortis risus.', 1061, 19.6, 5, 3008),
(4060, 'DVG51VCN7BO', 'vulputate, lacus. Cras interdum. Nunc', 2067, 19.6, 7, 3009),
(4061, 'NRU75FZA7RD', 'sodales nisi magna sed dui.', 5233, 19.6, 4, 3009),
(4062, 'RLS90WTD3NF', 'velit justo nec ante. Maecenas', 2774, 19.6, 6, 3006),
(4063, 'HCG08UHU8CL', 'interdum. Nunc sollicitudin commodo ipsum.', 3421, 19.6, 4, 3002),
(4064, 'LZR19SZR8JF', 'Pellentesque habitant morbi tristique senectus', 1897, 19.6, 7, 3006),
(4065, 'XYS10NZH3UK', 'tellus id nunc interdum feugiat.', 4307, 19.6, 10, 3000),
(4066, 'YKC65AIN6EX', 'et, euismod et, commodo at,', 1542, 19.6, 3, 3006),
(4067, 'WDM53MBH7JB', 'malesuada ut, sem. Nulla interdum.', 961, 19.6, 8, 3001),
(4068, 'GSO33CIR6AW', 'eu nibh vulputate mauris sagittis', 5542, 19.6, 2, 3008),
(4069, 'MZW95ELP4FZ', 'vehicula et, rutrum eu, ultrices', 2425, 19.6, 2, 3002),
(4070, 'OJZ06IEA0UA', 'ultrices. Duis volutpat nunc sit', 2020, 19.6, 10, 3010),
(4071, 'BKY93LDU0PA', 'lacus. Quisque purus sapien, gravida', 663, 19.6, 4, 3001),
(4072, 'JYM30ERF1RZ', 'augue ac ipsum. Phasellus vitae', 3290, 19.6, 4, 3001),
(4073, 'NKO43YXM7YB', 'ultrices posuere cubilia Curae; Donec', 5847, 19.6, 2, 3001),
(4074, 'CNB58CTN2XE', 'Morbi vehicula. Pellentesque tincidunt tempus', 679, 19.6, 8, 3006),
(4075, 'GGZ87ITQ7MP', 'eu metus. In lorem. Donec', 1362, 19.6, 6, 3010),
(4076, 'IRN42JNZ8UX', 'habitant morbi tristique senectus et', 467, 19.6, 10, 3008),
(4077, 'QGB60TYV3SH', 'quis, pede. Suspendisse dui. Fusce', 3288, 19.6, 6, 3005),
(4078, 'NWE02KKT4GO', 'enim, condimentum eget, volutpat ornare,', 1994, 19.6, 7, 3003),
(4079, 'CGO18QXV4HN', 'dignissim pharetra. Nam ac nulla.', 1417, 19.6, 2, 3002),
(4080, 'SPB86IIA0SG', 'at, iaculis quis, pede. Praesent', 362, 19.6, 6, 3002),
(4081, 'JSN98KNT2YA', 'Vestibulum ante ipsum primis in', 4085, 19.6, 3, 3008),
(4082, 'XZJ98ZHE9KX', 'Sed id risus quis diam', 276, 19.6, 10, 3009),
(4083, 'HIN72JEU1KS', 'enim. Mauris quis turpis vitae', 812, 19.6, 5, 3004),
(4084, 'XHJ22GHO4GZ', 'aliquet diam. Sed diam lorem,', 3187, 19.6, 10, 3003),
(4085, 'JHQ80XHG6KQ', 'fringilla est. Mauris eu turpis.', 3432, 19.6, 8, 3008),
(4086, 'ZRC39JPF9AM', 'nisi sem semper erat, in', 2444, 19.6, 2, 3009),
(4087, 'SJE32GHO4YY', 'Aenean massa. Integer vitae nibh.', 2024, 19.6, 6, 3009),
(4088, 'DMP28NPL7NL', 'diam luctus lobortis. Class aptent', 2706, 19.6, 10, 3003),
(4089, 'IPR59YTG4GE', 'felis orci, adipiscing non, luctus', 2280, 19.6, 5, 3010),
(4090, 'HPM88HJL7DZ', 'id ante dictum cursus. Nunc', 2480, 19.6, 5, 3000),
(4091, 'RTP32OHA8TG', 'ut mi. Duis risus odio,', 1274, 19.6, 7, 3005),
(4092, 'EWC67XYC3QG', 'ultrices a, auctor non, feugiat', 4952, 19.6, 7, 3007),
(4093, 'WIM46SBY7WS', 'dui. Fusce diam nunc, ullamcorper', 4968, 19.6, 10, 3006),
(4094, 'HBL37EHQ2QH', 'gravida molestie arcu. Sed eu', 5597, 19.6, 4, 3002),
(4095, 'QYN14FVM1OI', 'blandit. Nam nulla magna, malesuada', 3061, 19.6, 2, 3008),
(4096, 'BLV48ORC1YS', 'adipiscing non, luctus sit amet,', 2821, 19.6, 7, 3005),
(4097, 'QHM13XKF3OU', 'neque. Morbi quis urna. Nunc', 2539, 19.6, 3, 3009),
(4098, 'EIH08COM1SK', 'a ultricies adipiscing, enim mi', 1098, 19.6, 9, 3005),
(4099, 'SNU27FDC4NR', 'amet lorem semper auctor. Mauris', 1457, 19.6, 1, 3005);
...
INSERT INTO `clients` (`idClient`, `nomClient`, `prenomClient`, `emailClient`, `adresseClient`, `cpClient`, `idPays`) VALUES
...
(2000, 'bernard', 'minette', 'alloLaTerre@laLune.be', '33 rue du cheminee', 40280, 0),
...
INSERT INTO `commandes` (`id`, `idCmd`, `idClient`, `dateCmd`, `totalHT`, `totalTVA`, `valid`) VALUES
(1, 5000, 2022, '2013-03-05 18:38:54', 2.06441e+06, 0, 0),
(2, 5001, 2055, '2013-03-05 18:39:53', 70865.8, 0, 0),
(3, 5002, 2013, '0000-00-00 00:00:00', 218942, 0, 0),
(4, 5003, 2053, '0000-00-00 00:00:00', 34362, 0, 0),
(5, 5004, 2000, '0000-00-00 00:00:00', 0, 0, 0);
...
INSERT INTO `fournisseurs` (`idFournisseur`, `nomFournisseur`, `telFournisseur`, `adresseFournisseur`) VALUES
...
INSERT INTO `groupes` (`idgroup`, `groupname`) VALUES
(1, 'administrateur'),
(2, 'utilisateur');
...
INSERT INTO `produitcmd` (`id`, `idArticle`, `idCmd`, `qteCmd`, `totalHT`, `remise`) VALUES
(1, 4004, 5000, 2, 2888, NULL),
(2, 4009, 5000, 1, 1874, NULL),
(3, 4016, 5001, 1, 548, NULL),
(4, 4000, 5001, 3, 14559, NULL),
(6, 4000, 5000, 2, 131.04, NULL),
(9, 4003, 5001, 4, 11262.2, NULL),
(13, 4005, 5002, 100, 0, NULL),
(14, 4088, 5002, 7, 18942, NULL),
(15, 4008, 5003, 6, 0, NULL),
(16, 4010, 5003, 2, 5888, NULL),
(17, 4091, 5003, 20, 25480, NULL),
(18, 4091, 5003, 20, 25480, NULL),
(19, 4091, 5003, 20, 25480, NULL),
(20, 4091, 5003, 20, 25480, NULL),
(21, 4091, 5003, 20, 25480, NULL),
(22, 4091, 5003, 20, 25480, NULL),
(23, 4091, 5003, 20, 25480, NULL),
(25, 4011, 5004, 8, 0, NULL);
...
INSERT INTO `utilisateurs` (`iduser`, `login`, `password`, `idgroup`) VALUES
